---- MODULE TwoPhase_TTrace_1710927562 ----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("TwoPhase_TTrace_1710927562.json", _TETrace)
...
\*
\*trace == IODeserialize("TwoPhase_TTrace_1710927562.bin", TRUE)
\*
\*=============================================================================
\*
...
---- CONFIG TwoPhase_TTrace_1710927562 ----
CONSTANTS
    RM = { n1 , n2 , n3 , n4 , n5 }
    n3 = n3
    n2 = n2
...
ALIAS
    _expression
=============================================================================
\* Generated on Wed Mar 20 17:39:23 CST 2024