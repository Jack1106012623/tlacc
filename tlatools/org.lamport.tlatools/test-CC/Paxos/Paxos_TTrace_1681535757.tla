---- MODULE Paxos_TTrace_1681535757 ----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("Paxos_TTrace_1681535757.json", _TETrace)
...
\*
\*trace == IODeserialize("Paxos_TTrace_1681535757.bin", TRUE)
\*
\*=============================================================================
\*
...
trace == 
    ...
    ([msgs |-> {[type |-> "1a", bal |-> 0]},maxVal |-> (a1 :> None @@ a2 :> None @@ a3 :> None),maxBal |-> (a1 :> -1 @@ a2 :> -1 @@ a3 :> -1),maxVBal |-> (a1 :> -1 @@ a2 :> -1 @@ a3 :> -1)])
    >>
----
...
---- CONFIG Paxos_TTrace_1681535757 ----
CONSTANTS
    Acceptor = { a1 , a2 , a3 }
    Value = { v1 , v2 }
...
ALIAS
    _expression
=============================================================================
\* Generated on Sat Apr 15 13:15:57 CST 2023