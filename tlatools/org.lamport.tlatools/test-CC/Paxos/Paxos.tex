...
\end{cpar}%
\end{lcom}%
\@x{ {\CONSTANT} Value ,\, Acceptor ,\, Quorum ,\, Ballot ,\, None}%
\@pvspace{8.0pt}%
 \@x{ {\ASSUME} QuorumAssumption \.{\defeq} \.{\land} \A\, Q \.{\in} Quorum
 \.{:} Q \.{\subseteq} Acceptor}%
 \@x{\@s{145.19} \.{\land} \A\, Q1 ,\, Q2 \.{\in} Quorum \.{:} Q1 \.{\cap} Q2
 \.{\neq} \{ \}}%
\@pvspace{8.0pt}%
\@x{}%
\@y{\@s{0}%
 \ensuremath{Ballot \.{\defeq} Nat
}}%
\@xx{}%
\@pvspace{8.0pt}%
\@x{}%
\@y{\@s{0}%
 \ensuremath{None \.{\defeq} {\CHOOSE} v} : \ensuremath{v \.{\notin} Value
}}%
\@xx{}%
\begin{lcom}{8.2}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\end{cpar}%
\end{lcom}%
 \@x{ Message \.{\defeq}\@s{20.5} [ type\@s{2.83} \.{:} \{\@w{1a} \} ,\,
 bal\@s{1.93} \.{:} Ballot ]}%
 \@x{\@s{49.10} \.{\cup}\@s{15.97} [ type\@s{2.83} \.{:} \{\@w{1b} \} ,\, acc
 \.{:} Acceptor ,\, bal \.{:} Ballot ,\,}%
 \@x{\@s{78.97} mbal \.{:} Ballot \.{\cup} \{ \.{-} 1 \} ,\, mval \.{:} Value
 \.{\cup} \{ None \} ]}%
 \@x{\@s{49.10} \.{\cup}\@s{15.97} [ type\@s{2.83} \.{:} \{\@w{2a} \} ,\,
 bal\@s{1.93} \.{:} Ballot ,\, val \.{:} Value ]}%
 \@x{\@s{49.10} \.{\cup}\@s{15.97} [ type\@s{2.83} \.{:} \{\@w{2b} \} ,\, acc
 \.{:} Acceptor ,\, bal \.{:} Ballot ,\, val \.{:} Value ]}%
\@x{}\midbar\@xx{}%
\@x{ {\VARIABLE} maxBal ,\,}%
\@x{\@s{46.84} maxVBal ,\,}%
\@y{\@s{0}%
...
\@xx{}%
\@x{\@s{46.84} maxVal ,\,\@s{12.29}}%
\@y{\@s{0}%
 ballot number cast by a; it equals \ensuremath{{\langle}\.{-}1,\,
 None{\rangle}} if
}%
\@xx{}%
\@x{\@s{98.54}}%
...
\end{lcom}%
\@pvspace{8.0pt}%
 \@x{ vars \.{\defeq} {\langle} maxBal ,\, maxVBal ,\, maxVal ,\, msgs
 {\rangle}}%
\begin{lcom}{8.2}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
It is convenient to define some identifier to be the tuple of all
 variables. I like to use the identifier \ensuremath{vars} .
\end{cpar}%
\end{lcom}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
...
\end{cpar}%
\end{lcom}%
 \@x{ TypeOK \.{\defeq} \.{\land} maxBal \.{\in} [ Acceptor \.{\rightarrow}
 Ballot \.{\cup} \{ \.{-} 1 \} ]}%
 \@x{\@s{56.14} \.{\land} maxVBal \.{\in} [ Acceptor \.{\rightarrow} Ballot
 \.{\cup} \{ \.{-} 1 \} ]}%
 \@x{\@s{56.14} \.{\land} maxVal \.{\in} [ Acceptor \.{\rightarrow} Value
 \.{\cup} \{ None \} ]}%
\@x{\@s{56.14} \.{\land} msgs \.{\subseteq} Message}%
\@pvspace{16.0pt}%
 \@x{ Init \.{\defeq} \.{\land} maxBal \.{=} [ a \.{\in} Acceptor \.{\mapsto}
 \.{-} 1 ]}%
 \@x{\@s{35.70} \.{\land} maxVBal \.{=} [ a \.{\in} Acceptor \.{\mapsto} \.{-}
 1 ]}%
 \@x{\@s{35.70} \.{\land} maxVal \.{=} [ a \.{\in} Acceptor \.{\mapsto} None
 ]}%
\@x{\@s{35.70} \.{\land} msgs \.{=} \{ \}}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
...
In an implementation, there will be a leader process that orchestrates
 ...
 \ensuremath{Phase1a(b)} and
 \ensuremath{Phase2a(b)}. The \ensuremath{Phase1a(b)} action sends a phase
 \ensuremath{1a} message (a message
 \ensuremath{m} with \ensuremath{m.type \.{=} \@w{1a}}) that begins ballot
 \ensuremath{b}.
\end{cpar}%
\end{lcom}%
 \@x{ Phase1a ( b ) \.{\defeq} \.{\land} Send ( [ type \.{\mapsto}\@w{1a} ,\,
 bal \.{\mapsto} b ] )}%
 \@x{\@s{69.22} \.{\land} {\UNCHANGED} {\langle} maxBal ,\, maxVBal ,\, maxVal
 {\rangle}}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 Upon receipt of a ballot \ensuremath{b} phase \ensuremath{1a} message,
 acceptor a can perform a
 \ensuremath{Phase1b(a)} action only if \ensuremath{b \.{>} maxBal[a]}. The
 action sets \ensuremath{maxBal[a]} to
 \ensuremath{b} and sends a phase \ensuremath{1b} message to the leader
 containing the values of
 \ensuremath{maxVBal[a]} and \ensuremath{maxVal[a]}.
\end{cpar}%
\end{lcom}%
\@x{ Phase1b ( a ) \.{\defeq} \.{\land} \E\, m \.{\in} msgs \.{:}}%
\@x{\@s{84.43} \.{\land} m . type \.{=}\@w{1a}}%
\@x{\@s{84.43} \.{\land} m . bal \.{>} maxBal [ a ]}%
 \@x{\@s{84.43} \.{\land} maxBal \.{'} \.{=} [ maxBal {\EXCEPT} {\bang} [ a ]
 \.{=} m . bal ]}%
 \@x{\@s{84.43} \.{\land} Send ( [ type \.{\mapsto}\@w{1b} ,\, acc \.{\mapsto}
 a ,\, bal \.{\mapsto} m . bal ,\,}%
 \@x{\@s{128.29} mbal \.{\mapsto} maxVBal [ a ] ,\, mval \.{\mapsto} maxVal [
 a ] ] )}%
\@x{\@s{69.22} \.{\land} {\UNCHANGED} {\langle} maxVBal ,\, maxVal {\rangle}}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 in the
 definition of \ensuremath{Phase2a(b,\, v)}. This second conjunct, expressing
 condition (ii), is the heart of the algorithm. To understand it,
 observe that the existence of a phase \ensuremath{1b} message \ensuremath{m}
 in \ensuremath{msgs} implies that
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{m.mbal} is the highest ballot number less than \ensuremath{m.bal}
 in which acceptor
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{m.acc} has or ever will cast a vote, and that \ensuremath{m.mval}
 is the value it
 voted for in that ballot if \ensuremath{m.mbal \.{\neq} \.{-}1}. It is not
 hard to deduce from
 this that the second conjunct implies that there exists a quorum
 \ensuremath{Q} such
 that \ensuremath{ShowsSafeAt(Q,\, b,\, v)} (where \ensuremath{ShowsSafeAt}
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 that it
 can vote for \ensuremath{v} in ballot \ensuremath{b}, unless it has already
 set \ensuremath{maxBal[a]
 } greater than \ensuremath{b} (thereby promising not to vote in ballot
 \ensuremath{b}).
\end{cpar}%
\end{lcom}%
\@x{ Phase2a ( b ,\, v ) \.{\defeq}}%
...
\@xx{}%
 \@x{\@s{8.2} \.{\land} {\lnot} \E\, m \.{\in} msgs\@s{7.89} \.{:} m . type
 \.{=}\@w{2a} \.{\land} m . bal \.{=} b}%
\@x{\@s{8.2} \.{\land} \E\, Q \.{\in} Quorum \.{:}}%
 \@x{\@s{26.53} \.{\LET} Q1b \.{\defeq} \{ m \.{\in} msgs\@s{6.20} \.{:}
 \.{\land} m . type \.{=}\@w{1b}}%
\@x{\@s{148.25} \.{\land} m . acc \.{\in} Q}%
\@x{\@s{148.25} \.{\land} m . bal\@s{1.57} \.{=} b \}}%
\@x{\@s{51.03} Q1bv \.{\defeq} \{ m \.{\in} Q1b \.{:} m . mbal \.{\geq} 0 \}}%
 \@x{\@s{26.53} \.{\IN}\@s{4.09} \.{\land} \A\, a \.{\in} Q \.{:} \E\, m
 \.{\in} Q1b \.{:} m . acc \.{=} a}%
\@y{\@s{0}%
 收到多数派\ensuremath{1b}回复
}%
\@xx{}%
\@x{\@s{51.03} \.{\land} \.{\lor} Q1bv \.{=} \{ \}}%
\@x{\@s{62.14} \.{\lor} \E\, m\@s{7.71} \.{\in} Q1bv \.{:}}%
\@x{\@s{81.45} \.{\land} m . mval \.{=} v}%
 \@x{\@s{81.45} \.{\land} \A\, mm \.{\in} Q1bv \.{:} m . mbal \.{\geq} mm .
 mbal}%
 \@x{\@s{8.2} \.{\land} Send ( [ type \.{\mapsto}\@w{2a} ,\, bal \.{\mapsto} b
 ,\, val \.{\mapsto} v ] )}%
 \@x{\@s{8.2} \.{\land} {\UNCHANGED} {\langle} maxBal ,\, maxVBal ,\, maxVal
 {\rangle}}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 a
 phase \ensuremath{2a} message. Acceptor a can perform this action only if the
 message is for a ballot number greater than or equal to
 \ensuremath{maxBal[a]}. In
 that case, the acceptor votes as directed by the phase \ensuremath{2a}
 message,
 setting \ensuremath{maxVBal[a]} and \ensuremath{maxVal[a]} to record that
 vote and sending a
 phase \ensuremath{2b} message announcing its vote. It also sets
 \ensuremath{maxBal[a]} to the
 message\mbox{'}s. ballot number
\end{cpar}%
\end{lcom}%
 \@x{ Phase2b ( a ) \.{\defeq} \E\, m \.{\in} msgs \.{:} \.{\land} m . type
 \.{=}\@w{2a}}%
\@x{\@s{128.83} \.{\land} m . bal \.{\geq} maxBal [ a ]}%
 \@x{\@s{128.83} \.{\land} maxBal \.{'} \.{=} [ maxBal {\EXCEPT} {\bang} [ a ]
 \.{=} m . bal ]}%
 \@x{\@s{128.83} \.{\land} maxVBal \.{'} \.{=} [ maxVBal {\EXCEPT} {\bang} [ a
 ] \.{=} m . bal ]}%
 \@x{\@s{128.83} \.{\land} maxVal \.{'} \.{=} [ maxVal {\EXCEPT} {\bang} [ a ]
 \.{=} m . val ]}%
 \@x{\@s{128.83} \.{\land} Send ( [ type \.{\mapsto}\@w{2b} ,\, acc
 \.{\mapsto} a ,\,}%
 \@x{\@s{168.59} bal \.{\mapsto} m . bal ,\, val\@s{2.06} \.{\mapsto} m . val
 ] )}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
In an implementation, there will be learner processes that learn from
 the phase \ensuremath{2b} messages if a value has been chosen. The learners
 are
...
\end{cpar}%
\end{lcom}%
 \@x{ Next \.{\defeq} \.{\lor} \E\, b\@s{0.64} \.{\in} Ballot \.{:} \.{\lor}
 Phase1a ( b )}%
\@x{\@s{112.86} \.{\lor} \E\, v \.{\in} Value \.{:} Phase2a ( b ,\, v )}%
 \@x{\@s{39.83} \.{\lor} \E\, a \.{\in} Acceptor \.{:} Phase1b ( a ) \.{\lor}
 Phase2b ( a )}%
\@pvspace{8.0pt}%
...
\end{cpar}%
\end{lcom}%
\@x{ votes \.{\defeq} [ a \.{\in} Acceptor \.{\mapsto}}%
 \@x{\@s{48.30} \{ {\langle} m . bal ,\, m . val {\rangle} \.{:} m \.{\in} \{
 mm \.{\in} msgs \.{:} \.{\land} mm . type \.{=}\@w{2b}}%
\@x{\@s{212.90} \.{\land} mm . acc \.{=} a \} \} ]}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 We now instantiate module Voting, substituting the constants
 \ensuremath{Value},
 Acceptor, and \ensuremath{Quorum} declared in this module for the
 corresponding
 constants of that module Voting, and substituting the variable
 \ensuremath{maxBal
 } and the defined state function \ensuremath{votes} for the
...
\@x{}%
\@y{\@s{0}%
 \ensuremath{V \.{\defeq} {\INSTANCE}} Voting
}%
\@xx{}%
\@pvspace{8.0pt}%
\@x{}%
\@y{\@s{0}%
 \ensuremath{{\THEOREM}} \ensuremath{Spec \.{\implies} V{\bang}Spec
}}%
\@xx{}%
\@x{}\midbar\@xx{}%
\begin{lcom}{0}%
...
\@x{}%
\@y{\@s{0}%
 \ensuremath{Inv \.{\defeq} \.{\land} TypeOK
}}%
\@xx{}%
\@x{}%
\@y{\@s{17.5}%
 \ensuremath{\.{\land} \A\, a \.{\in} Acceptor} : \ensuremath{{\IF}}
 \ensuremath{maxVBal[a] \.{=} \.{-}1
}}%
\@xx{}%
\@x{}%
\@y{\@s{80.0}%
 \ensuremath{\.{\THEN} maxVal[a] \.{=} None
}}%
\@xx{}%
\@x{}%
\@y{\@s{80.0}%
 \ensuremath{\.{\ELSE} {\langle}maxVBal[a],\, maxVal[a]{\rangle} \.{\in}
 votes[a]
}}%
\@xx{}%
\@x{}%
\@y{\@s{17.5}%
 \ensuremath{\.{\land} \A\, m \.{\in} msgs} :
}%
\@xx{}%
\@x{}%
\@y{\@s{32.5}%
 \ensuremath{\.{\land}} (\ensuremath{m.type \.{=} \@w{1b}})
 \ensuremath{\.{\implies} \.{\land} maxBal[m.acc] \.{\geq} m.bal
}}%
\@xx{}%
\@x{}%
\@y{\@s{87.5}%
 \ensuremath{\.{\land}} (\ensuremath{m.mbal \.{\geq} 0})
 \ensuremath{\.{\implies}
}}%
\@xx{}%
\@x{}%
\@y{\@s{97.5}%
 \ensuremath{{\langle}m.mbal,\, m.mval{\rangle} \.{\in} votes[m.acc]
}}%
\@xx{}%
\@x{}%
\@y{\@s{32.5}%
 \ensuremath{\.{\land}} (\ensuremath{m.type \.{=} \@w{2a}})
 \ensuremath{\.{\implies} \.{\land} \E\, Q \.{\in} Quorum} :
}%
\@xx{}%
\@x{}%
\@y{\@s{102.5}%
 \ensuremath{V{\bang}ShowsSafeAt(Q,\, m.bal,\, m.val)
}}%
\@xx{}%
\@x{}%
\@y{\@s{87.5}%
 \ensuremath{\.{\land} \A\, mm \.{\in} msgs} : \ensuremath{\.{\land} mm.type
 \.{=} \@w{2a}
}}%
\@xx{}%
\@x{}%
\@y{\@s{137.5}%
 \ensuremath{\.{\land} mm.bal \.{=} m.bal
}}%
\@xx{}%
\@x{}%
\@y{\@s{137.5}%
 \ensuremath{\.{\implies} mm.val \.{=} m.val
}}%
\@xx{}%
\@x{}%
\@y{\@s{17.5}%
 \ensuremath{\.{\land} V{\bang}Inv
}}%
\@xx{}%
\@x{}\bottombar\@xx{}%
\end{document}
