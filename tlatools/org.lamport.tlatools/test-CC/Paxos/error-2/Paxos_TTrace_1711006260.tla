---- MODULE Paxos_TTrace_1711006260 ----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("Paxos_TTrace_1711006260.json", _TETrace)
...
\*
\*trace == IODeserialize("Paxos_TTrace_1711006260.bin", TRUE)
\*
\*=============================================================================
\*
...
---- CONFIG Paxos_TTrace_1711006260 ----
CONSTANTS
    Acceptor = { a1 , a2 , a3 }
    Value = { v1 , v2 }
    Ballot = { 0 , 1 }
...
ALIAS
    _expression
=============================================================================
\* Generated on Thu Mar 21 15:31:01 CST 2024