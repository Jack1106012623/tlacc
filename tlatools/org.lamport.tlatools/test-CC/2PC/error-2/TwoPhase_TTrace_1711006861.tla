---- MODULE TwoPhase_TTrace_1711006861 ----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("TwoPhase_TTrace_1711006861.json", _TETrace)
...
\*
\*trace == IODeserialize("TwoPhase_TTrace_1711006861.bin", TRUE)
\*
\*=============================================================================
\*
...
---- CONFIG TwoPhase_TTrace_1711006861 ----
CONSTANTS
    RM = { n1 , n2 , n3 , n4 , n5 }
    n2 = n2
    n3 = n3
...
ALIAS
    _expression
=============================================================================
\* Generated on Thu Mar 21 15:41:02 CST 2024