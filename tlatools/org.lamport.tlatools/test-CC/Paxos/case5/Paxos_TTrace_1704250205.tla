---- MODULE Paxos_TTrace_1704250205 ----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("Paxos_TTrace_1704250205.json", _TETrace)
...
\*
\*trace == IODeserialize("Paxos_TTrace_1704250205.bin", TRUE)
\*
\*=============================================================================
\*
...
---- CONFIG Paxos_TTrace_1704250205 ----
CONSTANTS
    Acceptor = { a1 , a2 , a3 }
    Value = { v1 , v2 }
    Quorum <- MCQuorum
...
ALIAS
    _expression
=============================================================================
\* Generated on Wed Jan 03 10:50:06 CST 2024