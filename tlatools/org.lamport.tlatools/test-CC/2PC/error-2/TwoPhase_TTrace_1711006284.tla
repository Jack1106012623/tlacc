---- MODULE TwoPhase_TTrace_1711006284 ----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("TwoPhase_TTrace_1711006284.json", _TETrace)
...
\*
\*trace == IODeserialize("TwoPhase_TTrace_1711006284.bin", TRUE)
\*
\*=============================================================================
\*
...
---- CONFIG TwoPhase_TTrace_1711006284 ----
CONSTANTS
    RM = { n1 , n2 , n3 , n4 , n5 }
    n4 = n4
    n5 = n5
...
ALIAS
    _expression
=============================================================================
\* Generated on Thu Mar 21 15:31:25 CST 2024